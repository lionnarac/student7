...
namespace Student7.Controllers
{
    ...
    public class InquiriesController : Controller
    {
        ...
        //public  IList<Inquiry> Index()
        {
            var inquiries = _context.Inquiry.Where(u => u.UserId ==_userManager.GetUserId(User)).ToList();
            foreach (var inquiry in inquiries)
            {
                var CrmInquiry = _orgService.Retrieve("new_inquiry", inquiry.InquiryId, new ColumnSet("new_response"));
